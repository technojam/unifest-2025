const teamMembers = [
  ...
  {
    coverImage: "/logo/Humans_of_Galgotias.png",
  ...
  {
    coverImage: "/logo/Sponsorship.png",
  ...
  {
    coverImage: "/logo/Cyber cell.png",
    title: "Cyber Cell",
    headTitle: "Club Heads",
    headImage1:
  ...
  {
    coverImage: "/logo/The_Humanity_Saviours.png",
  ...
  {
    coverImage: "/coverimages/gci.webp",
  ...
  {
    coverImage: "/logo/BusinessClub.png",
    title: "Business Club",
    headTitle: "Club Heads",
    headImage1:
  ...
  {
    coverImage: "/logo/scintillitions.png",
  ...
  description:"GDC is the dance society of GUSC where we represent different forms of dance." },
