    ...
    <div className="flex flex-col items-center w-full pt-10">
      ...
      <div className="relative flex flex-col items-center pt-25 my-10 text-white w-full max-w-5xl">
        <div id="timeline" className="relative flex flex-col items-center w-full">
          {/* Day 1 Box */}
          <div className="absolute left-1/2 transform -translate-x-1/2 -top-10 bg-[#970900] text-[#E3ED7B] px-6 py-3 font-bold text-lg text-center rounded z-10">
            DAY 01
            <br />
            21 MARCH
          </div>
          ...
          <div className="w-full flex flex-col md:flex-row justify-between gap-14 pt-20">
            <div className="w-1/2 space-y-5 pr-5">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={`day1-left-event-${i + 1}`} className="bg-[#970900] p-3 text-lg rounded-lg">
            ...
            <div className="w-1/2 space-y-5 pl-5">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={`day1-right-event-${i + 1}`} className="bg-[#970900] p-3 text-lg rounded-lg">
                  <div className="flex justify-between items-center">
                    <p>10:00</p>
                    <button className="border px-4 text-sm">DIGITAL</button>
                  </div>
          ...
          <div className="mt-15 flex flex-col items-center z-10 text-center">
            <div className="bg-[#970900]  text-[#E3ED7B] px-6 py-3 font-bold text-lg rounded">
              DAY 02
              <br />
              22 MARCH
            </div>
          ...
          <div className="w-full flex flex-col md:flex-row justify-between gap-14 pt-15">
            <div className="w-1/2 space-y-5 pr-5">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={`day2-left-event-${i + 1}`} className="bg-[#970900] p-3 text-lg rounded-lg">
                  <div className="flex justify-between items-center">
                    <p>10:00</p>
                    <button className="border px-4 text-sm">DIGITAL</button>
                  </div>
            ...
            <div className="w-1/2 space-y-5 pl-5">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={`day2-right-event-${i + 1}`} className="bg-[#970900] p-3 text-lg rounded-lg">
